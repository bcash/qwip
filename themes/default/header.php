<?php
	...
	$Site['themelist'] = array( 
		...
		'Unicorn' => '//alpine.s3.amazonaws.com/services/bootstrap-themes/paintstrap-2795842-c918c8c8/bootstrap.min.css'
 	
	);

	// Other header goes here
	if ( isset( $_GET['theme'] ) && isset( $Site['themelist'][$_GET['theme']] ) ) {
		$User['preferences']['theme'] = $_GET['theme'];
	}
	
	$theme = $Site['themelist']['Default'];
	if ( isset( $User['preferences']['theme'] ) && isset( $Site['themelist'][$User['preferences']['theme']] ) ) {
		$theme = $Site['themelist'][$User['preferences']['theme']];
	}
...
<html lang="en" class="no-js">
	<head>
		...
		<meta name="author" content="Alpine Internet Solutions - http://www.alpineinternet.com/">
		<meta name="generator" content="Wave, the WebApps platform">
		...
		<!-- Vendor Styles -->
		<script src="//alpine.s3.amazonaws.com/services/modernizr-2.6.2/modernizr.custom.14811.js"></script>
